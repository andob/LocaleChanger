...
public class ClosestMatchingAlgorithmTest {
    ...
    private static final Locale LOCALE_FR_FR_VARIANT = new Locale("fr", "FR", "1694acad");

    private static final Locale LOCALE_EN_US = new Locale("en", "US");
    private static final Locale LOCALE_FR_FR = new Locale("fr", "FR");

    private static final List<Locale> SYSTEM_LOCALES = Arrays.asList(LOCALE_EN_US, LOCALE_FR_FR, LOCALE_FR_FR_VARIANT);

    private MatchingAlgorithm sut;

    @Before
    public void setUp() throws Exception {
        sut = new ClosestMatchingAlgorithm();
    }
    ...
    public void ShouldFindFirstSystemLanguageMatchingLocale_WhenFindDefaultMatch_GivenMatchingLocales() {
        // Given
        List<Locale> supportedLocalesWithMultipleMatches = Arrays.asList(LOCALE_ES_ES, LOCALE_FR_CA, LOCALE_EN_GB, LOCALE_FR_FR_VARIANT);
    ...
    public void ShouldFindFirstSystemLanguageMatchingLocale_WhenFindMatch_GivenMatchingLocale() {
        // Given
        Locale matchingLocale = LOCALE_FR_FR_VARIANT;
